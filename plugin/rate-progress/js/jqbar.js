        ...
        jqbar: function (options) {
            ...
            return this.each(function () {
                ...
                if (settings.orientation == 'h') {
                    ...
                    progressContainer.addClass('jqbar horizontal').append('<span class="bar-label"></span><span class="bar-percent"></span><span class="bar-level-wrapper"><span class="bar-level"></span></span>');
                ...
                function animateProgressBar(progressBar) {
                    ...
                    if (settings.orientation == 'h') {
                        ...
                        progressContainer.find('.bar-percent').animate({ top: (h - valueLabelHeight) }, 10000);
