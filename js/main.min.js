...
(function () {
    ...
    Riode.defaults = {
        ...
        sliderPresets: {
            ...
            'product-single-carousel': {
                ...
                loop: true,
                autoplay: true,              // ← این
                autoplayTimeout: 5000,       // ← فاصله هر اسلاید (۵ ثانیه)
                autoplayHoverPause: true,    // ← هاور کنی وایمیسته
                rtl: false 
            },
        ...
        stickyFooter: {
            minWidth: 0,
            maxWidth: 767,
            top: -1,      // یا 0، ولی -1 باعث می‌شه از اسکرول 0 هم fixed بشه
            hide: false,  // دیگه از اول مخفی نباشه
            scrollMode: false
        },
        stickyToolbox: {
            minWidth: 0,
        ...
        zoomImage: {
            ...
            //zoomType: 'inner',
            //cursor: 'crosshair',
            //zoomEnabled: $(window).width() > 768 ? true : false
    ...
    Riode.stickyContent = function (selector, settings) {
        ...
        var refreshStickyContent = function (e) {
            ...
            $stickyContents.each(function (index) {
                ...
                if (window.pageYOffset > (false == options.top ? $item.data('top') : options.top) && window.innerWidth >= options.minWidth && window.innerWidth <= options.maxWidth) {
                    ...
                    if (options.scrollMode) {
                        //if ($item.hasClass('fix-top') || $item.hasClass('fix-bottom')) {
        ...
        var resizeStickyContent = function (e) {
            // اگر این استیکی مربوط به فوتر موبایله، روی عرض موبایل چیزی انجام نده
            return;

            //if (window.innerWidth <= 767 && selector === '.sticky-footer') {
            //    return;
            //}
        ...
        ProductSingle.prototype.init = function ($el) {
            ...
            $slider.on('initialized.owl.carousel', function (e) {
                ...
                if (!document.body.classList.contains('home')) {
                    ...
                    self.isQuickview || $slider.append('<a href="#" class="product-image-full"><i class="d-icon-zoom"></i><span>بزرگنمایی</span></a>');
                }
    ...
    Riode.initLayout = function () {
        ...
        Riode.isotopes('.reza', { filter: '.homefilter_1'});
